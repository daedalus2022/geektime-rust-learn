...
mod tests {
    ...
    use crate::{storage::MemTable, CommandRequest, CommandResponse, Service, ServiceInner, Value};

    use super::assert_res_ok;
    ...
    fn service_should_works() {
        ...
        // service 可以运行在多线程的环境下， 他的clone 应该是轻量级的
    ...
    #[test]
    fn event_registration_shold_work() {
